<?php 
    //iniciar sessao para usar os $_SESSION :p
    session_start();
?>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <?php
                        //se status_cadastro exisitir(true) renderizar div
                    ...
                    <?php 
                        ...
                        //limpar sessao para a div nao ficar renderizando
                    ...
                    <?php 
                        ...
                        //limpar sessao para nao renderizar div
                        unset($_SESSION['usuario_existe']);
                    ?>

                    <div class="box">
                        <!-- formulario chama cadastrar.php, por isso que as variaveis chamam esses dados -->
